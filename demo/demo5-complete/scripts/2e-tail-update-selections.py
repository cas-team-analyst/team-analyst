...
def main():
    """Update Tail Factor Selections Excel file with selections from JSON."""
    ...
    print(f"Loaded {len(selections)} rules-based tail selections from {SELECTIONS_FILE}")
    ...
    if os.path.exists(AI_SELECTIONS_FILE):
        ...
        print(f"Loaded {len(ai_selections)} open-ended AI tail selections from {AI_SELECTIONS_FILE}")
    else:
