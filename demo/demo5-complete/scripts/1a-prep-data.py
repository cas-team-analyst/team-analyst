...
EXPECTED_LOSS_RATES_FILE = "canonical-elrs.xlsx"  # ELR file with Expected Loss Rate and Expected Frequency
...
def read_and_process_expected_loss_rates(triangle_data: pd.DataFrame, file_path: Optional[str] = None) -> Optional[pd.DataFrame]:
    ...
    # canonical-elrs.xlsx uses 'Accident Period', 'Expected Loss Rate', 'Expected Frequency'
