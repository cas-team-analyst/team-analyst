...
- [ ] Ask the user if they would like to each selection independently (slower, will use many more tokens, better selections expected) or all at once (faster, fewer tokens).
