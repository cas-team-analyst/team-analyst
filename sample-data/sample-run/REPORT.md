...
Sample run of the TeamAnalyst reserving workflow using provided triangle data. Purpose is to demonstrate the end-to-end analysis pipeline including Chain Ladder LDF selections, tail factors, and ultimate selections.
...
| Coverages | Loss (Paid and Incurred); Claim Counts (Reported) |
| Basis | Not specified (assumed gross) |
| Currency | USD |
